...
export function HomeContent() {
  ...
  return (
    <>
      <section className="mx-auto grid w-full max-w-(--content-max) items-center gap-8 px-(--page-gutter) pb-14 pt-9 md:grid-cols-[minmax(0,1fr)_24rem] md:px-0 md:pb-16 md:pt-8 lg:grid-cols-[minmax(0,1fr)_27rem]">
        <div className="max-w-2xl">
          ...
          <p className="mt-5 max-w-xl text-sm leading-6 text-muted-foreground">
            ...
            consagrados. Colecione arte digital rara, apoie artistas
        ...
        <div className="min-w-0">
          <div className="mb-6 flex flex-wrap items-end justify-between gap-4 border-b border-border/70">
            <div className="flex gap-5 text-sm">
              ...
              <Link
                to="/marketplace"
                className="pb-3 text-foreground hover:text-primary"
              >
                Novos lançamentos
              </Link>
          ...
          <nav
            aria-label="Prévia da paginação"
        ...
        <article className="grid overflow-hidden bg-card md:grid-cols-[10rem_minmax(0,1fr)]">
          ...
          <div className="grid place-items-center p-6 text-center">
            <div>
              ...
              >
                Colecione edições escassas diretamente dos criadores
                antes da revelação pública.
              </Typography>
          ...
          <div className="grid place-items-center p-6 text-center">
            <div>
              ...
              <Typography
                ...
                className="mt-2 text-xs"
              >
                Explore novos artistas, coleções verificadas e obras
