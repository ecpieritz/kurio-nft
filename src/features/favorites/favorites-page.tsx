...
export function FavoritesPage() {
  ...
  return (
    ...
    >
      ...
      <Typography
        tone="muted"
        className="mb-8 mt-3 max-w-2xl"
      >
        Seus NFTs favoritos ficam sincronizados com a conta ativa e
        permanecem após o refresh.
      </Typography>
      ...
      {isPending ? (
        ...
        <section className="rounded-card border bg-card p-8 text-center">
          ...
          <Typography
            ...
            className="mt-3"
          >
            Favorite uma obra no catálogo ou nos detalhes do NFT para
            encontrá-la aqui.
          </Typography>
        </section>
      ) : (
